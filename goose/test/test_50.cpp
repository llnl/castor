...
main(int argc, char *argv[]) {
    ...
    const auto input_grammar = PEG::Grammar::instance(
        "json",
        {
            ...
            {"object",{
                seq_n({
                    term("{"), non_term("members"), term("}")
                }),
                seq_n({
                    term("{"),
                    PEG::Expressions::OptionalExpression::instance(non_term("ws")),
                    term("}")
                })
            }},
            {"members",{
            ...
            {"string",{
                seq_n({
                    term("\""),
                    PEG::Expressions::RepeatExpression::instance(non_term("character")),
                    term("\"")
                })
            }},
            {"character",{
            ...
            {"number",{
                seq_n({
                    ...
                    non_term("integer"),
                    PEG::Expressions::OptionalExpression::instance(non_term("fraction")),
            ...
            {"exponent",{
                seq_n({
                    term("E"),
                    PEG::Expressions::OptionalExpression::instance(non_term("sign")),
                    non_term("digits")
                }),
                seq_n({
                    term("e"),
            ...
            {"ws", {
                PEG::Expressions::RepeatExpression::instance(non_term("whitespace")),
            }},
            {"whitespace", {
                term(" "),
                term("\n"),
