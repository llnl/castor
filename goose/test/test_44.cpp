...
main(int argc, char *argv[]) {
    const auto input_grammar = PEG::Grammar::instance(
        "json",
        {
            ...
            {"members",
             {seq(non_term("member"), PEG::Expressions::RepeatExpression::instance(seq(term(","), non_term("member"))))}
            },
            ...
            {"elements",
             {seq(
                 non_term("element"), PEG::Expressions::RepeatExpression::instance(seq(term(","), non_term("element")))
             )}},
