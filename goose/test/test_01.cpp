...
make_grammar() {
    ...
    auto plain_parse_tree_factory = PEG::ParseTree::PlainParseTreeFactory::instance<PEG::ParseTree::PlainParseTreeFactory>();
    auto g_term = PEG::Expressions::TerminalExpression::instance("whitespace", plain_parse_tree_factory);
    ...
    PEG::ExpressionPtr g_non_term_2 = PEG::Expressions::NonTerminalExpression::instance(g_last, value_factory_interface);
    ...
    PEG::ExpressionPtr g_term_7 = PEG::Expressions::SequenceExpression::instance(
        PEG::Expressions::SequenceExpression::instance(
            PEG::Expressions::TerminalExpression::instance("-", value_factory_interface),
            PEG::Expressions::NotExpression::instance(
                PEG::Expressions::TerminalExpression::instance("1", value_factory_interface), value_factory_interface
            ),
            value_factory_interface
        ),
        PEG::Expressions::TerminalExpression::instance("5", value_factory_interface), value_factory_interface
    );

    std::string g_ones = "ones";
    PEG::ExpressionPtr g_term_6 = PEG::Expressions::RepeatExpression::instance(
        PEG::Expressions::TerminalExpression::instance("-1", value_factory_interface), value_factory_interface
    );
    PEG::ExpressionPtr g_term_8 = PEG::Expressions::NonTerminalExpression::instance(g_ones, value_factory_interface);
    PEG::ExpressionPtr g_term_9 = PEG::Expressions::SequenceExpression::instance(
        PEG::Expressions::TerminalExpression::instance("6+", value_factory_interface), g_term_8, value_factory_interface
    );
    ...
    std::vector<PEG::ExpressionPtr> g_rule_3({g_term_3, g_term_7, g_term_9});
    std::vector<PEG::ExpressionPtr> g_rule_4({g_term_6});
...
int
main() {
    std::cout << "hello, world to test repeat!" << std::endl;

    auto plain_parse_result_factory = PEG::ValueFactoryInterface::instance<PEG::ParseTree::PlainParseTreeFactory>();

    auto parser = PEG::Parser(make_grammar());
    const std::string input = " 6+ -1 -1";
    const auto parseResult = parser.parse(input);
    std::cout << "parse finished" << std::endl;
    std::cout << " success: " << parseResult->isSuccess() << std::endl;
    std::cout << " full success: " << parseResult->isFullSuccess() << std::endl;
    parseResult->output();
